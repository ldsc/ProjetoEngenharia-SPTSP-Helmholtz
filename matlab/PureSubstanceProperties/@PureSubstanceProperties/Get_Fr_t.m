...
for n=1:obj.n_coef_pol;
    obj.fr_t=obj.fr_t+(coef_1(n,3)*coef_1(n,2)*D^coef_1(n,1)*T^(coef_1(n,2)-1));
end
for n=1:obj.n_coef_exp;
    obj.fr_t=obj.fr_t+(coef_2(n,4)*coef_2(n,3)*D^coef_2(n,2)*T^(coef_2(n,3)-1)*obj.e^(-D^coef_2(n,1)));
end
...
for n=1:obj.n_coef_nonanalitic;
    ...
    obj.fr_t=obj.fr_t+coef_4(n,4)*D*((delta^coef_4(n,2))*ex_t+deltab_t*ex);
end
end
